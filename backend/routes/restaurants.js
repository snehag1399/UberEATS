...
router.put('/profile', auth, async (req, res) => {
    ...
    const queryPromise2 = () => {
        const sql2 = `UPDATE restaurants SET name= '${name}', delivery_option= '${delivery_option}', phone_number= '${phone_number}', description= '${description}', timing_open= '${timing_open}', timing_close= '${timing_close}', where res_id= '${res_id}'`;
